	...
	$(".linechart_pic,.piechart_pic").click(function(){
		...
		if(amchartdivId!=null){
			...
			if(!amchartdivObj[0]){
				...
				buildLineChart(resultJson,quICount);
			}
		}
		return false;
	});
...
function buildLineChart(resultJson,quId){
									...
									<%--是非题 --%>
										<c:when test="${en.quType eq 'YESNO' }">
													<table class="suQuTable" border="0" cellpadding="0" cellspacing="0">
														<tr>
															<td width="15px" align="right" style="color: #000000;">1.&nbsp;&nbsp;</td>
															<td width="520px">${en.yesnoOption.trueValue }</td>
															<td width="40px">&nbsp;</td>
														</tr>
														<tr>
															<td width="15px" align="right" style="color: #000000;">2.&nbsp;&nbsp;</td>
															<td width="520px">${en.yesnoOption.falseValue  }</td>
															<td width="40px">&nbsp;</td>
														</tr>
													</table>
													<div id="statJson_${i.count }" style="display: none;">${en.statJson }</div>
													<div id="chartdivId_${i.count }" style="height: 300px;width: 80%;">--</div>
													<script type="text/javascript">
										...
										<c:when test="${en.quType eq 'RADIO' }">
											...
											<c:forEach items="${en.quRadios }" var="quEn" varStatus="quI">
														<tr>
															<td width="15px" align="right" style="color: #000000;">${quI.count}.&nbsp;&nbsp;</td>
											...
											<div style="clear:both;"></div>
											<div class="reportPic">
												<a href="#" class="dw_btn026 linechart_pic">柱状图</a>
												<div style="clear: both;"></div>
